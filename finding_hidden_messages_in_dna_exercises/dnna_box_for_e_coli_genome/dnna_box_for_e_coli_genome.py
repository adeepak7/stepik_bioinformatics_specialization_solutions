from finding_hidden_messages_in_dna import find_dnaa_box_based_on_mismatches_and_reverse_complements
...
if __name__ == "__main__":
    ...
    map_to_store_the_most_frequent_k_mers_in_a_window_of_given_length_around_minimum_skew_value, set_of_most_frequent_k_mers_who_are_exactly_present_in_the_text = find_dnaa_box_based_on_mismatches_and_reverse_complements(text, 9, 500, 1)
